			...
			<main>
				...
				<div class='content'>
					...
					<ul class="nav nav-tabs">
						<li class="nav-item"><a class="nav-link active" aria-current="page" href="#">개인 수업</a></li>
						<li class="nav-item"><a class="nav-link" href="#">그룹 수업</a></li>
					</ul>
					
					<div class="list-group">
						<div class="list-group-title">
							<p>홍길동 강사</p>
							<p><h5 class="mb-1">콤비리포머(A): 재활, 스트레칭</h5></p>
						</div>
						...
						<div class="list-group-time1">
							<p><b>오전</b></p>
								<div class="form-check">
									<input type="radio" class="btn-check" name="options" id="option1" autocomplete="off" disabled="disabled">
									<label class="btn btn-outline-primary" for="option1">09:00</label>
									
									<input type="radio" class="btn-check" name="options" id="option2" autocomplete="off">
									<label class="btn btn-outline-primary" for="option2">10:00</label>
									
									<input type="radio" class="btn-check" name="options" id="option3" autocomplete="off">
									<label class="btn btn-outline-primary" for="option3">11:00</label>
								</div>
						</div>
						
						<div class="list-group-time2">
						
							<p><b>오후</b></p>
								<div class="form-check">
									<input type="radio" class="btn-check" name="options" id="option4" autocomplete="off" disabled>
									<label class="btn btn-outline-primary" for="option4">12:00</label>
									
									<input type="radio" class="btn-check" name="options" id="option5" autocomplete="off" checked>
									<label class="btn btn-outline-primary" for="option5">01:00</label>
									
									<input type="radio" class="btn-check" name="options" id="option6" autocomplete="off">
									<label class="btn btn-outline-primary" for="option6">02:00</label>
									
									
									<input type="radio" class="btn-check" name="options" id="option7" autocomplete="off">
									<label class="btn btn-outline-primary" for="option7">03:00</label>
								</div>
							
							</div>
						</div>						
					<div class="d-grid gap-2">
						<button class="btn btn-primary" type="button" style="border-radius: 0;" data-bs-toggle="modal" data-bs-target="#staticBackdrop">예약하기</button>
					</div>
				</div>
								...
								<div class="modal-body">
									...
									<div class="card" style="width: 100%;">
										...
										<ul class="list-group list-group-flush">
											<li class="list-group-item">XX필라테스 xx점 | 개인수업</li>
