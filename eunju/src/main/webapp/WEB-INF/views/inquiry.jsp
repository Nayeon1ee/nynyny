...
<head>
<meta charset="UTF-8">
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resources/css/inquiryStyle.css">
<script src="${pageContext.request.contextPath}/resources/js/inquiryJs.js"></script>
...
<body>
	<div class="container000">
		...
		<div id="myPage">
        <h3><a href="memberPage.jsp">마이페이지</a> > 문의사항</h3>
        <div id="userInfo">
        ...
        <div class="inquiry-header">
            <button class="inquiry-button">센터문의하기</button>
            <hr>
        </div>
