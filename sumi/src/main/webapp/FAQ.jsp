...
<div class="FAQ-reg">
<button type="button" onclick="location.href='${pageContext.request.contextPath }/FAQ_register.jsp'" class="btn btn-primary left-align">FAQ등록</button>
</div>
              ...
              <table class="table datatable">
                ...
                <tbody>
                  <tr>
                    <th scope="row">5</th>
                    <td>강사</td>
                    <td><a href="${pageContext.request.contextPath }/FAQ_detail.jsp" class="admin-alink-color">출결처리가 되지않아요</a></td>
                    <td>2023-10-23</td>
                  </tr>
                  <tr>
                    <th scope="row">4</th>
                    <td>회원</td>
                    <td><a href="#" class="admin-alink-color">내 이용권을 확인하고 싶어요</a></td>
                    <td>2023-06-30</td>
                  </tr>
                  <tr>
                    <th scope="row">3</th>
                    <td>강사</td>
                    <td><a href="#" class="admin-alink-color">오늘 수업 일정으로 확인하고 싶어요</a></td>
                    <td>2022-03-15</td>
                  </tr>
                  <tr>
                    <th scope="row">2</th>
                    <td>공통</td>
                    <td><a href="#" class="admin-alink-color">연동된 센터를 확인하고 싶어요</a></td>
                    <td>2021-08-19</td>
                  </tr>
                  <tr>
                    <th scope="row">1</th>
                    <td>공통</td>
                    <td><a href="#" class="admin-alink-color">회원 탈퇴는 어떻게 하나요?</a></td>
                    <td>2020-02-24</td>
                  </tr>
                </tbody>
              </table>   
