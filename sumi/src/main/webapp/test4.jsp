...
<link rel="stylesheet"
	href="/qqq/resources/bootstrap/css/bootstrap_Nayeon.css">
<link rel="stylesheet" href="/qqq/resources/bootstrap/css/select.css">
<script type="text/javascript"
	src="/qqq/resources/bootstrap/js/bootstrap.js"></script>
</head>
<body>
	<script>
document.addEventListener('DOMContentLoaded', function () {
    ...
    listItem.addEventListener('click', function () {
        if (hiddenContent.style.display === 'none') {
            hiddenContent.style.display = 'block'; // 클릭 시 보이게
        } else {
            hiddenContent.style.display = 'none'; // 다시 클릭 시 숨김
        }
    });
});
</script>
			...
			<main>
				...
				<div class='ticket'>
					...
					<section class="ticket-list">
						...
						<div class="card text-center" id="hidden-content"
							style="display: none;">
							<div class="card-header-title">척추가 부서지는 필라테스</div>
							<div class="card-body">
								<ul>
									<li>수업 유형 : 6:1 그룹레슨</li>
									<li>수업 횟수 : 24회</li>
									<li>사용 기간 : 2023.10.10~2024.01.01</li>
									<li>금액 : 533,000원</li>
								</ul>
							</div>
							...
							<div class="card-body">
								...
								<div class="form-check">
									<input class="form-check-input" type="checkbox" value=""
										...
										for="flexCheckDefault"> 이용 정책을 모두 확인 하였습니다. 이에 동의합니다.</label>
								</div>
							</div>
						...
						<div class="card text-dark bg-light" style="max-width: 40rem;">
							<div class="card-header">1:1 개인레슨 24회 (3개월)</div>
							<div class="card-body">
								<h5 class="card-title">척추가 맞춰지는 필라테스</h5>
								<div>
									<table>
										<td>
										<tr>2023.10.10~2024.01.01
